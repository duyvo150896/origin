...
function trongcay()
Say("Thu ho¹ch c©y b¸t nh· lín : <color=green>"..GetTask(1500).."<color>/12\nThu ho¹ch c©y b¸t nh· nhá : <color=green>"..GetTask(1501).."<color>/12\nThu ho¹ch c©y tø linh : <color=green>"..GetTask(2677).."<color>/12", 7,
        "NhËn th­ëng/kimmall",
		"KÕt thóc ®èi tho¹i/np");
	return
end

function trongcansa()
Say("H­íng dÉn tham gia <color=green>Sù KiÖn CÇn Sa V·i Lån<color> nÌ nha mÊy con ®ñy, ®äc kü tr­íc khi ch¬i nghe h«n\n1. C¸c h¹ h·y ®i lªn <color=white>V­¬ng MÉu §éng-TÇng 3<color>\n2. <color=white>HiÕp D©m<color> mÊy con <color=white>Tiªn N÷<color> trªn ®ã vµ c­íp <color=gold>Linh §Þch<color> cña tôi nã\n3. Dïng <color=gold>20 Linh §Þch<color> ®Ó ®æi lÊy <color=green>1 MÇm C©y CÇn Sa<color>\n4. §em trång <color=green>CÇn Sa<color> t¹i <color=gold>T©y BiÖn Kinh hoÆc V¨n Méng Tr¹ch<color> ®Ó t×m lÖnh bµi ®æi th­ëng",7,
        "T¹i h¹ CÇn §æi MÇm C©y CÇn Sa/nhancansa",
		"T¹i h¹ yÕu kÐm, ®Ðo d¸m ch¬i cÇn nªn xin rót lui/np");
	return
end

function nhancansa()
	if GetItemCount(2,1,187) < 20 then
		Talk(1, "", "§¹i hiÖp vui lßng <color=white>HiÕp D©m<color> thªm <color=white>Tiªn N÷<color> vµ lÊy ®ñ <color=gold>Linh §Þch<color> råi h·y quay l¹i ®©y ®æi <color=green>CÇn Sa<color> mµ bó?")
		return
	end
    ...
    if DelItem(2,1,187,20) == 1 then
    		...
    		Msg2Global("§· nhËn 1 MÇm C©y CÇn Sa, h·y mang nã trång ë T©y BiÖn Kinh hoÆc V¨n Méng Tr¹ch ®Ó t×m kiÕm phÇn th­ëng vµ bó cÇn cùc m¹nh nµo")
...
function SelectSay()	
	...
	if VET_CheckIpBonus() == 1 then
		...
		--ÎäÁÖvipÔÂ¿¨
	--tinsert(tbSayDialog,"Sù kiÖn CÇn Sa V·i Lån (Míi NhÊt - Hot NhÊt)/trongcansa"	)
	...
	--tinsert(tbSayDialog,"NhiÖm vô trång c©y mçi ngµy/trongcay"	)	
	----------------------------------
