...
tb_topserver_award_limit = {				
				[50] = {  1000,   1000,   10000,     0},
				[55] = {  1500,   1500,   20000,     1},
				[60] = {  2000,   2000,   25000,     2},
				[65] = {  2500,   2500,   30000,     3},
				[70] = {  3000,   4000,   35000,     4},
				[71] = {  3000,   4000,   40000,     5},
				[72] = {  2700,   4000,   45000,     6},
				[73] = {  3000,   4000,   50000,     7},
				[74] = {  3000,   4000,   50000,     8},
				[75] = {  3000,   4000,   50000,     9},
				[76] = {  3000,   4000,   50000,     10},
				[77] = {  3000,   4000,   50000,     11},
				[78] = {  4000,   5000,   55000,     12},
				[79] = {  5000,   5000,   55000,     13},
				[80] = {  6000,   5000,   55000,     14},
				...
				[89] = {10000, 10000,   80000,     23},
				[90] = {10000, 10000,   80000,     24},
				[91] = {11000, 11000,   85000,     25},
...
local tbVukhiVietYen = {
		...
		[23] = {"ViÖt Yªn H¹ NhËt KiÕm", {0,2,29989,1,1,-1,-1,-1,-1,-1,-1,-1,13}},
		[25] = {"ViÖt Yªn H¹ NhËt §ao", {0,3,29995,1,1,-1,-1,-1,-1,-1,-1,-1,13}},
		[26] = {"ViÖt Yªn H¹ NhËt Bót", {0,9,29991,1,1,-1,-1,-1,-1,-1,-1,-1,13}},
		[27] = {"ViÖt Yªn H¹ NhËt Tr¶o", {0,11,29993,1,1,-1,-1,-1,-1,-1,-1,-1,13}},
		[29] = {"ViÖt Yªn H¹ NhËt Vò", {0,13,29997,1,1,-1,-1,-1,-1,-1,-1,-1,13}},
		[30] = {"ViÖt Yªn H¹ NhËt Tiªu", {0,12,29999,1,1,-1,-1,-1,-1,-1,-1,-1,13}},
}
...
tb_topserver_award_item = {				
				...
				[70] = {{1, "L¨ng Ba Vi Bé", {0,112,78,1,1}, 0}, {2, "Earn(%d)", 1000000, 0}},
				...
				[75] = {{3, tb_topserver_book70_1, 0, 0}, {2, "Earn(%d)", 1000000, 0}},
				[76] = {{1, "GÊu Manh Manh", {0,105,150,1,1,-1,-1,-1,-1,-1,-1,-1}, 30*24*60*60}},
...
--				[83] = {{3, tb_golden_book_all, 0, 0}, {2, "Earn(%d)", 10000000, 0}},
				...
				[85] = {{3, tb_topserver_book_low, 0, 0},{3, tbVukhiVietYen, 0, 0},{1, "M¶nh B¹ch Kim", {2,1,30346,1,1}, 0}},
