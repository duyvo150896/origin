...
<div class="card-body  mt-xl-0 pt-0">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col  text-center tofront ">
                ...
                <a class="nav-link text-decoration-none uwp-account-account  active" href="editprofile.php?page_id=95">
                    <i class="fas fa-user mr-1 fa-fw"></i>Chỉnh sửa tài khoản                </a>
            </li>
                        <li class="nav-item m-0 p-0 list-unstyled mx-md-2 mx-2">
                <a class="nav-link text-decoration-none uwp-account-change-password " href="changepwd.php/?page_id=95&amp;type=change-password">
                ...
                <a class="nav-link text-decoration-none uwp-account-delete-account " href="#/?page_id=95&amp;type=delete-account">
                    <i class="fas fa-user-times mr-1 fa-fw"></i>Xóa tài khoản                </a>
                        ...
                        <li class="nav-item m-0 p-0 list-unstyled mx-md-2 mx-2">
                <a class="nav-link text-decoration-none uwp-account-logout " href="logi.php?action=logout&amp;redirect_to=logout.php">
            ...
            <div class="col-lg-9">
                <div class="pl-lg-4 pl-sm-0 h-100 pt-5 pb-lg-0 pb-3">
                    <h3 class="mb-lg-5 mb-4">Chỉnh Sửa Thông Tin</h3>            
                ...
                <div data-argument="first_name" class="form-group">
                    <label for="first_name" class="sr-only  ">Họ <span class="text-danger">*</span></label>
                    <input type="text" name="first_name" id="first_name" placeholder="Họ *" title="Họ" required="" class="form-control "></div>
                <div data-argument="last_name" class="form-group">
                    <label for="last_name" class="sr-only  ">Tên <span class="text-danger">*</span></label>
                        <input type="text" name="last_name" id="last_name" placeholder="Tên *" title="Tên" required="" class="form-control "></div>
                <div data-argument="email" class="form-group">
                    <label for="email" class="sr-only  "><span class="text-danger"><?php echo $user['email'] ?></span></label>
                        <input type="email" name="email" id="email" placeholder="Email *" title="Email" value="" required="" class="form-control "></div>
                <div data-argument="display_name" class="form-group">
                    <label for="display_name" class="sr-only  ">Tên Hiển Thị</label>
                        <input type="text" name="display_name" id="display_name" placeholder="Tên Hiển Thị" title="Tên Hiển Thị" value="" class="form-control "></div><div data-argument="bio" class="form-group">
                    <label for="bio" class="sr-only">Tiểu Sử <span class="text-danger">*</span></label>
                        <textarea name="bio" id="bio" placeholder="Tiểu Sử *" title="Tiểu Sử" required="" rows="4" class="form-control "></textarea></div>                
