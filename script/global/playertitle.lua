...
function PT_AddAllWhenEquip(type, stateID, number1, number2)
	if 1 == type then
		...
		Msg2Player(format("%s%d%%s%d%s%d","Hi謚 qu?nh薾 頲: T╪g t鑓  thi tri觧", number1, ",T╪g Sinh l鵦", number2, " 甶觤", "T╪g Sinh l鵦", 10000));
	end
end
...
function PT_AddAllWhenEquip_duyvo(type, stateID, number1, number2, number3)
	if 1 == type then
		...
		-- Msg2Player(format("%s%d%s%d%s%d","Hi謚 qu?: KTC", number1, "  t╪g sinh l鵦 : ", number2, "  Sinh l鵦 t╪g: ", number3));
	end
end
...
function PT_AddAllWhenEquip_duyvo_2(type, stateID, number1, number2, number3)
	if 1 == type then
		...
		CastState("state_m_attack_percent_add", 15, -1, 1, stateID+ 3);
		CastState("state_p_attack_percent_add", 15, -1, 1, stateID+ 4);
		-- Msg2Player(format("%s%d%%s%d%s%s%d","Hi謚 qu?nh薾 頲: T╪g t鑓  thi tri觧", number1, ",T╪g Sinh l鵦", number2, " 甶觤", "T╪g Sinh l鵦", number3));
	end
end