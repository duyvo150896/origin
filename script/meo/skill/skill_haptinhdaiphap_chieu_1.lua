...
SKILL = {
    ...
    {
        { "skill_effect_persist_time", { { 1, 1 }, { 5, 3 }, { 10, 10 } } },
    },
    ...
    {
        { magic = "state_immune",
          damage_factor_z = { { 1, 1 }, { 5, 10 }, { 10, 75 } },
        },
        ...
        { magic = "state_knockback_attack",
          damage_factor_z = { { 1, 0 }, { 5, 2 }, { 10, 5 } },
        },
        { magic = "state_confusion_attack",
          damage_factor_z = { { 1, 0 }, { 5, 2 }, { 10, 5 } },
        },
        { magic = "state_slow_immune",
          damage_factor_z = { { 1, 1 }, { 5, 30 }, { 10, 100 } },
        },
