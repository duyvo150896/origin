...
SKILL = {
    ...
    SKILL_MAGIC_STATE_ATTRIB = --¼¼ÄÜµÈ¼¶Ïà¹Ø×´Ì¬Ä§·¨ÊôĞÔ
    {
        ...
        -- khi bŞ ®¸nh sÏ trë vµo state id 79
        { magic = "state_be_attacked_2_magic",
          damage_factor_z = { { 1, 6553679 }, { 10, 65536079 } },
        },
        -- khi tÊn c«ng sÏ trë vµo state id 80
        { magic = "state_npc_event_2_magic",
          damage_factor_z = { { 1, 6553680 }, { 10, 65536080 } },
        },
    },
