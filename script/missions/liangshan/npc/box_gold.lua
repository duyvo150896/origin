...
_t_ib_award_no_stage4 =
{
	...
	t_ib_award =--ib½±Àø
	{
                { {"C©y B¸t Nh· nhá", {2,0,504,1}, 7,nil, {1, 100}},10},
                { {"C©y B¸t Nh·", {2,0,398,1}, 7,nil, {1, 100}},10},
                { {"C©y Tø Linh", {2,1,30269,1}, 7,nil, {1, 100}},10},
                { {"B¹ch C©u Hoµn", {2,1,270,1}, 7,nil, {1, 100}},10},
                { {"N÷ Oa B¶o H¹p", {2,1,30154,5}, 7,nil, {1, 100}},1000},
                { {"B¹ch C©u Tiªn ®¬n", {2,1,1008,1}, 7,nil, {1, 100}},10},
                { {"§¹i Nh©n s©m", {2,95,2086,1}, 7,nil, {1, 100}},310},
                ...
                { {"Huy Ch­¬ng §ång ChÕ", {0,153,1,1}, nil,nil, {1, 100}},300},
                { {"Huy Ch­¬ng ThiÕt ChÕ", {0,153,2,1}, nil,nil, {1, 100}},300},
                { {"Huy Ch­¬ng Ngäc ChÕ", {0,153,3,1}, nil,nil, {1, 100}},300},
                { {"Huy Ch­¬ng Kim ChÕ ngò hµnh", {0,153,4,1}, nil,nil, {1, 100}},300},
                { {"Huy Ch­¬ng Méc ChÕ ngò hµnh", {0,153,5,1}, nil,nil, {1, 100}},300},
                { {"Huy Ch­¬ng Thñy ChÕ ngò hµnh", {0,153,6,1}, nil,nil, {1, 100}},300},
                { {"Huy Ch­¬ng Háa ChÕ ngò hµnh", {0,153,7,1}, nil,nil, {1, 100}},300},
                { {"Huy Ch­¬ng Thæ ChÕ ngò hµnh", {0,153,8,1}, nil,nil, {1, 100}},300},
                { {"Huy Ch­¬ng ¢m ChÕ ngò hµnh", {0,153,9,1}, nil,nil, {1, 100}},300},
...
_t_ib_award_no_stage8 =
{
	...
	t_ib_award =--ib½±Àø
	{
                ...
                { {"N÷ Oa B¶o H¹p", {2,1,30154,5}, 7,nil, {1, 100}},1000},
                { {"B¹ch C©u Tiªn ®¬n", {2,1,1008,1}, 7,nil, {1, 100}},10},
                { {"Bao Thiªn Kiªu LÖnh Nhá", {2,95,2086,1}, 7,nil, {1, 100}},310},
                { {"Hu©n ch­¬ng anh hïng", {2,1,30499,1,4}, nil,nil, {1, 100}},1500},
                { {"Hu©n ch­¬ng anh hïng", {2,1,30499,2,4}, nil,nil, {1, 100}},600},
                { {"Hu©n ch­¬ng anh hïng", {2,1,30499,4,4}, nil,nil, {1, 100}},400},
                { {"Hu©n ch­¬ng anh hïng", {2,1,30499,10,4}, nil,nil, {1, 100}},590},
