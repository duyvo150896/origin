...
-------------	
	...
	local nTypeDouble = floor(GetTask(TSK_NEWRES_POINT)/10000)
	SetTask(TSK_NEWRES_POINT,nTypeDouble * 10000)
	gf_AddItemEx2({2,1,random(30666,30668),1,1}, "Tinh Hoa UÈn Linh CÊp(NgÉu Nhiªn)", "nhËn th­ëng thµnh c«ng", "hoµn thµnh nhiÖm vô Tµi Nguyªn ChiÕn VIP", 30 * 24 * 3600, 1)
