...
-------------	
	...
	if nDate >= 130919 and nDate <=331013 then	
		gf_AddItemEx2({2,1,30400 ,100}, "Nguyªn liÖu Event", "Hoat dong thang 02 nam 2021", "hoµn thµnh nhiÖm vô Tµi Nguyªn ChiÕn VIP")
	...
	if rand < 3 then
		gf_AddItemEx2({2,1,random(30667,30668),1,1}, "Tinh Hoa UÈn Linh CÊp(NgÉu Nhiªn)", "nhËn th­ëng thµnh c«ng", "hoµn thµnh nhiÖm vô Tµi Nguyªn ChiÕn VIP", 30 * 24 * 3600, 1)
	end
