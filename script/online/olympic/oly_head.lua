...
OLY_ACTIVITY_DURATION = 172800000 --3600 * 24 * 2000days
...
function oly_GetLuckNumAward(nFlag)
	...
	if nNum1 == (nTgl /OLY_EXCHANGE_BASE) and (nNum1 /nFlag) == floor(nNum1 /nFlag) then
		...
		gf_AddItemEx2({2,95,204,2}, "Thiªn Cang LÖnh", szLogTitle, "NhËn th­ëng ch÷ sè may m¾n", 0, 1);
		...
		Msg2Global(format("Chóc mõng ng­êi ch¬i %s ®· rót th­ëng ®­îc Thiªn Cang LÖnh*%d",GetName(),2));
		--Áì½±±ê¼Ç
...
--			strName = "7¼¶ÁéÊ¯";
--		end
--		Msg2Global(format("¹§Ï²Íæ¼Ò%sÔÚ°¢ÔË»î¶¯ÖĞ»ñµÃ%s*1",GetName(),strName));
--	end
