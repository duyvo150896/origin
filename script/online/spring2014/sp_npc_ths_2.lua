...
Npc_Say_Title_201208 = "Tiªn N÷ Gi¸ng TrÇn TÆng Quµ Xu©n !";
...
Npc_Say_Dialog_201208 = {
	...
	"T¹i h¹ muèn ®æi B¸nh Ch­ng hoÆc B¸nh TÐt (tiªu hao 25 L¸ dong + 25 §Ëu xanh thÞt heo + 25 Vµng)/exchange_both",
...
VET_201208_ExcAw_TaskGroup = TaskManager:Create(7,10);
...
Max_Count = 2500; --Ã¿Ììµ¥Ïî×î¶µ8´Î
Exp_Award_Normal1 = 6000000;
Exp_Award_Normal2 = 12000000;
Item_Count1 = 25;
Item_Count2 = 25;
Coin_Consume = 25;
Item_table1 = {2,1,30619,"L¸ Dong"};
Item_table2 = {2,1,30620,"§Ëu Xanh ThÞt Heo"};

Acitivity_log1 = "HOAT DONG XUAN";
Acitivity_log2 = "Vui cïng chÞ H»ng";

strMsg2Player1 = "TÆng B¸nh N­íng %d/%d";
strMsg2Player2 = "TÆng B¸nh DÎo %d/%d";
strMsg2Player3 = "§æi b¸nh %d/%d";

--½±Àø±í
Vet_201208_Award  = {
	--{1, 2525, "B¨ng th¹ch", {2, 1, 149, 2}, 0},
    {1, 2000, "B¸nh Ch­ng", {2, 1, 30621, 1}, 0},
    {1, 1500, "B¸nh TÐt", {2, 1, 30622, 1}, 0},
...
Vet_201208_Award_Special  = {
    ...
    {1, 200, "M¶nh Thiªn Cang", {2, 1, 30390, 100}, 0},
    {3, 159, 9990000, 1},
};
