...
function trongcansa()
	local szSay = {
		g_szTitle.."H­uíng dÉn: §Ó nhËn ®­uîc <color=green>MÇm C©y CÇn Sa<color>. C¸c h¹ h·y ®Õn <color=green>V­u¬ng MÉu §éng - TÈng 3<color> hiÕp d©m mÊy con <color=white>Tiªn N÷<color> vµ lÊy <color=gold> 20 Linh §Þch<color> ®Ó ®æi lÊy <color=green>1 MÇm C©y CÇn Sa<color>",
		"§æi MÇm C©y CÇn Sa/tradecansa",
		"T¹i h¹ yÕu kÐm, kh«ng d¸m ch¬i CÇn Sa nªn xin rót lui/np",
	};
	SelectSay(szSay);
	return
end
...
function SelectSay()	
	...
	tinsert(tbSayDialog,"Sù kiÖn CÇn Sa V·i Lån/trongcansa"	)
	----------------------------------
