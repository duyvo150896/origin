...
tb_topserver_award_item = {				
				...
				[87] = {{1, "Nh©n S©m V¹n N¨m", {3, tbMatTich70caocap, 0, 0},{2,1,30071,5,1}, 30*24*60*60}},
...
--				[98] = {{3, tbMatTich70caocap, 0, 0}, {3, tbMatTich70caocap, 0, 0}, {3, tbMatTich70caocap, 0, 0}},
				[99] = {{1, "§¹i §Þnh Hån", {2,1,1113,1}, 30*24*60*60},{1, "ChuyÓn Sinh §¬n", {2,1,30345,1,4}, 60*24*60*60}},
