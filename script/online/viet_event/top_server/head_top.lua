...
tb_topserver_award_item = {				
				...
				[78] = {{2, "AddItem(0,105,30023,1,1,7,403,-1,-1,-1,-1,-1,0)",20, 0},{3, tbMatTich70caocap, 0, 0},{3, tbMatTich70caocap, 0, 0},{3, tbMatTich70caocap, 0, 0}, {2, "Earn(%d)", 3000000, 0},  {2, "AddItem(2,1,50029,1,1)",20, 0}},
				...
				[83] = {{2, "AddItem(0,102,8842,1,1,-1,-1,-1,-1,-1,-1,-1,0)",20, 0},{3, tb_topserver_book_high, 0, 0}, {2, "Earn(%d)", 10000000, 0}},
				[84] = {{2, "AddItem(0,102,8843,1,1,-1,-1,-1,-1,-1,-1,-1,0)",20, 0},{3, tb_topserver_book_med, 0, 0}, {1, "Thiªn Th¹ch Linh Th¹ch", {2,1,1068,1,4}, 30*24*60*60}},
				[85] = {{4, tbBKVDTrang, 0, 0},{3, tb_topserver_book_low, 0, 0}, {1, "M¶nh B¹ch Kim", {2,1,30346,1,1}, 0},{2, "AddItem(2,1,50029,1,1)",20, 0}},
				[86] = {{1, "Qu©n C«ng Vinh D", {2,1,30642,1,4}, 30*24*60*60}, {1, "Tñ ¸o", {2,1,1070,1,4}, 30*24*60*60}},
				[87] = {{1, "Nh©n S©m V¹n N¨m", {2,1,30071,5,1}, 30*24*60*60}},
				[88] = {{1, "Qu©n C«ng Vinh D", {2,1,30642,2,4}, 30*24*60*60}},
				[89] = {{1, "Qu©n C«ng Vinh D", {2,1,30642,2,4}, 30*24*60*60}},
				[90] = {{4, tbBKVDGiap, 0, 0},{3, tb_topserver_book_high, 0, 0}, {2, "Earn(%d)", 10000000, 0}, {2, "AddItem(2,1,50029,1,1)",20, 0}},
				[91] = {{1, "Qu©n C«ng Vinh D", {2,1,30642,5,1}, 30*24*60*60}},
				[92] = {{1, "Qu©n C«ng Vinh D", {2,1,30642,5,1}, 30*24*60*60}},
