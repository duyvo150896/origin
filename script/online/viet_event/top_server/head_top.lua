...
tb_topserver_award_limit = {				
				...
				[79] = {  5000,   5000,   50000,     3},
				[80] = {  6000,   5000,   55000,     4},
				[81] = {  6500,   6000,   55000,     5},
				[82] = {  7000,   7000,   60000,     6},
				[83] = {  8000,   8000,   60000,     7},
				[84] = {8000,   9000,   70000,     8},
				[85] = {8000, 10000,   85000,    9},
				[86] = {9000, 10000,   90000,    10},
				[87] = {10000, 10000,   90000,    11},
				[88] = {10000, 10000,   100000,    12},
				[89] = {10000, 10000,   120000,    13},
				[90] = {10000, 10000,   170000,    14},
				[91] = {11000, 11000,   180000,    15},
				[92] = {11000, 11000,   190000,    16},
				[93] = {11000, 11000,   195000,    17},
				[94] = {12000, 12000,   220000,    18},
--				[98] = {16000, 16000,   160000,    19},
				[99] = {14000, 14000,   250000,    19},
...
tbMatTich70caocap_nonx15  =
{
		[2] =  {"Kim Cang B¸t Nh· Ch©n QuyÓn", {0, 107, 204, 20}}, 
		[3] =  {"V« TrÇn Bå §Ò Ch©n QuyÓn", {0, 107, 206, 20}}, 
		[4] =  {"TiÒm Long Tóc DiÖt Ch©n QuyÓn", {0, 107, 205, 20}}, 
		[14] =  {"HuyÒn ¶nh Mª T«ng Ch©n QuyÓn", {0, 107, 212, 20}}, 
		[15] =  {"Qu©n Tö §íi Phong Ch©n QuyÓn", {0, 107, 213, 20}}, 
		[8] =  {"Nh­ ý Kim §Ønh Ch©n QuyÓn", {0, 107, 208, 20}}, 
		[9] =  {"BÝch H¶i TuyÖt ¢m Ch©n QuyÓn", {0, 107, 209, 20}}, 
		[11] =  {"Hçn §én TrÊn Nh¹c Ch©n QuyÓn", {0, 107, 210, 20}}, 
		[12] =  {"Quú Thiªn Du Long Ch©n QuyÓn", {0, 107, 211, 20}}, 
		[6] =  {"Thiªn La Liªn Ch©u Ch©n QuyÓn", {0, 107, 207, 20}}, 
		[17] =  {"TrÊn Qu©n Phi Long Th­¬ng Ch©n QuyÓn", {0, 107, 214, 20}}, 
		[18] =  {"Xuyªn V©n L¹c Hång Ch©n QuyÓn", {0, 107, 215, 20}}, 
		[20] = {"HuyÒn Minh Phong Ma Ch©n QuyÓn", {0, 107, 216, 20}}, 
		[21] = {"Linh Cæ HuyÒn Tµ Ch©n QuyÓn", {0, 107, 217, 20}}, 
		[23] = {"Cöu Thiªn Phong L«i Ch©n QuyÓn", {0,107,218, 20}}, 
		[29] = {"Hång TrÇn Tóy Méng Ch©n QuyÓn", {0,107,222, 20}}, 
		[30] = {"Phong Hoa Thiªn DiÖp Ch©n QuyÓn", {0,107,223, 20}}, 
}
...
tbMatTich70caocap  =
{
		...
		[29] = {"Hång TrÇn Tóy Méng Ch©n QuyÓn", {0,107,219+29797, 5}}, 
		[30] = {"Phong Hoa Thiªn DiÖp Ch©n QuyÓn", {0,107,220+29797, 5}}, 
}
tbBKVDnon  =
{
...
tb_topserver_award_item = {				
				[76] = {{3, tbMatTich70caocap_nonx15, 0, 0}, {2, "Earn(%d)", 1000000, 0}},
				[77] = {{3, tbMatTich70caocap_nonx15, 0, 0}, {2, "Earn(%d)", 2000000, 0}},
				[78] = {{2, "AddItem(0,105,30023,1,1,7,403,-1,-1,-1,-1,-1,0)",20, 0}, {2, "Earn(%d)", 3000000, 0},  {2, "AddItem(2,1,50029,1,1)",20, 0},{1, "M¶nh B¹ch Kim", {2,1,30346,60,1}, 0}},
				[79] = {{1, "Vâ L©m Cao Thñ", {2,1,1040,1,4}, 60*24*60*60}, {2, "Earn(%d)", 4000000, 0}},
				[80] = {{2, "AddItem(2,1,50009+mod(random(0,1000),%d),100)",20, 0},{3, tbMatTich70caocap, 0, 0},  {2, "Earn(%d)", 10000000, 0}},
				...
				[82] = {{3, tbMatTich70caocap, 0, 0},{4, tbBKVDnon, 0, 0},{2, "AddItem(2,1,50009+mod(random(0,1000),%d),100)",20, 0},{2, "AddItem(2,1,50009+mod(random(0,1000),%d),100)",20, 0}},
				[83] = {{2, "AddItem(0,102,8842,1,1,-1,-1,-1,-1,-1,-1,-1,0)",20, 0},{3, tbMatTich70caocap, 0, 0},{3, tb_topserver_book_high, 0, 0}, {2, "Earn(%d)", 10000000, 0}},
				[84] = {{2, "AddItem(0,102,8843,1,1,-1,-1,-1,-1,-1,-1,-1,0)",20, 0},{3, tbMatTich70caocap, 0, 0},{3, tb_topserver_book_med, 0, 0}, {1, "Thiªn Th¹ch Linh Th¹ch", {2,1,1068,1,4}, 30*24*60*60}},
				[85] = {{4, tbBKVDTrang, 0, 0},{3, tb_topserver_book_low, 0, 0}, {1, "M¶nh B¹ch Kim", {2,1,30346,1,1}, 0},{3, tbMatTich70caocap, 0, 0},{2, "AddItem(2,1,50029,1,1)",20, 0}},
				[86] = {{1, "Qu©n C«ng Vinh D", {2,1,30642,1,4}, 30*24*60*60}, {3, tbMatTich70caocap, 0, 0},{1, "Tñ ¸o", {2,1,1070,1,4}, 30*24*60*60}},
				[87] = {{3, tbMatTich70caocap, 0, 0},{1, "Nh©n S©m V¹n N¨m", {2,1,30071,20,1}, 30*24*60*60}},
				[88] = {{3, tbMatTich70caocap, 0, 0},{1, "Qu©n C«ng Vinh D", {2,1,30642,2,4}, 30*24*60*60}},
				[89] = {{3, tbMatTich70caocap, 0, 0},{1, "Qu©n C«ng Vinh D", {2,1,30642,2,4}, 30*24*60*60}},
				[90] = {{4, tbBKVDGiap, 0, 0},{3, tbMatTich70caocap, 0, 0},{3, tb_topserver_book_high, 0, 0}, {2, "Earn(%d)", 10000000, 0}, {2, "AddItem(2,1,50029,1,1)",20, 0}},
				[91] = {{3, tbMatTich70caocap, 0, 0},{1, "Qu©n C«ng Vinh D", {2,1,30642,5,1}, 30*24*60*60}},
				[92] = {{3, tbMatTich70caocap, 0, 0}, {1, "Qu©n C«ng Vinh D",{2,1,30642,5,1}, 30*24*60*60}},
				[93] = {{1, "Bao Thiªn Th¹ch Tinh Th¹ch", {2,1,1051,1,1}, 30*24*60*60}},
...
--				[98] = {{3, tbMatTich70caocap, 0, 0}, {3, tbMatTich70caocap, 0, 0}, {3, tbMatTich70caocap, 0, 0}},
				[99] = {{1, "Bao Thiªn Th¹ch Tinh Th¹ch", {2,1,1051,1,4}, 30*24*60*60},{1, "ChuyÓn Sinh §¬n", {2,1,30345,1,4}, 60*24*60*60}},
...
function TopCheckLevel()
	...
	local nTaskVal = gf_GetTaskByte(TSK_TOP_LEVEL,1) --2665
	for i = 396, 76, -1 do
