...
TSK_SONGLIAO_BET_1 = 2164 -- Dù ®o¸n Tèng Liªu ®ît 1
TSK_SONGLIAO_BET_2 = 2165 -- Dù ®o¸n Tèng Liªu ®ît 2
...
-- Reset task ¨n B¸nh N­íng Vu«ng (event T10/2010)
	...
	-- Reset task ®æi ®iÓm ch©n khİ h»ng ngµy
	if tonumber(date("%y%m%d%H")) >= 12060100 then
