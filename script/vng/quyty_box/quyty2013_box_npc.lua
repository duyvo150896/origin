...
function give_weapon9()
	 tAttribute_quyty_first = {	--tAttribute_bkl_first
					...
					[4]  	= {53,	27, 	{{6,600}, {7,400}}},
					[5] 	= {54,	27, 	{{6,600}, {7,400}}},
					[6] 	= {63,	27, 	{{5,500}, {6,450}, {7,50}}}, --ptngoai-
					[7] 	= {64,	200, 	{{4,500}, {5,450}, {6,50}}}, --ptnoi -
					[8] 	= {85,	27,	 	{{5,700}, {6,250}, {7,50}}}, --ngoia%
					[9] 	= {86,	27,	 	{{1,700}, {2,250}, {3,50}}}, --noi %
					[10] 	= {94,	27, 	{{5,300}, {6,500}, {7,200}}},
					[11] 	= {95,	27,	{{5,300}, {6,500}, {7,200}}},
					[12] 	= {96,	27, 	{{5,300}, {6,500}, {7,200}}},
					[13] 	= {97,	27, 	{{5,300}, {6,500}, {7,200}}},
					[14] 	= {98,	27, 	{{5,300}, {6,500}, {7,200}}},
					[15] 	= {102,	27, 	{{5,400}, {6,500}, {7,100}}}, --ktc
					[16] 	= {111,	27, 	{{5,300}, {6,300}, {7,400}}}, -- dtt
					[17] 	= {252,	200,		{{3,800}, {2,150}, {4,50}}},	--bqpn
					[18]  	= {268,	27, 		{{1,800}, {2,150}, {3,50}}},		--st
					[19]  	= {277,	27,	{{3,400}, {4,400}, {5,200}}},		--Sinh l?c tang /1%
					[20]  	= {278,	27,	{{3,400}, {4,400}, {5,200}}},
					[21]  	= {285,	27,	{{4,700}, {5,150}, {6,150}}},
					[22]  	= {304,	27, 	{{4,800}, {5,150}, {6,50}}},
					[23]  	= {308,	27, 	{{5,600}, {6,300}, {7,100}}},
					[24] 	= {390,	27,	 	{{1,750}, {2,200}, {3,50}}},				 -- xxxc
		}	
	local tWeapon_quyty = { --tWeapon_bkl
				{9870, "¢m D­¬ng ¢n", 0, 0, 16},
				{10, "Kh«ng Cã",	 0, 1, 55},
				{10, "Nha Cöu", 0, 2, 38},
				{10, "NghÞch L©n",	0, 3, 66},
				{10, "B¸t X¹ Chi X¹", 0,	4,	121},
				{10, "ThÇn Ch©m", 0, 5, 42},
				{10, "Th­¬ng N«",	0,	6, 110},
				{10, "Thiªn T«n", 0, 7, 14},
				{10, "D­îc S­ Tr­îng", 0, 8, 99},
				{10, "Th¸i H­",	 0, 9, 88},
				{10, "Kh« Méc Long Ng©m", 	0,	10, 77},
				{10, "Thanh Long", 0, 11, 14},
				{10, "U©n H­¬ng", 0, 12, 14},
				{10, "Hoan Linh", 0, 13, 14},
		}
