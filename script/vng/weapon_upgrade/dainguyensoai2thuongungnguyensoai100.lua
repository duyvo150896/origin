...
function OnPutinComplete(param)
	...
	-------------------- Check material ----------------------------
	local tbMaterial = {
		[1] = {item={{gdp={2,1,504,9}, name="N÷ Oa Tinh Th¹ch"}, {gdp={2,95,204,19}, name="Thiªn Cang LÖnh"}, {gdp={2,1,30370,19}, name="Thiªn M«n Kim LÖnh"}, {gdp={2,1,30230,3900}, name="Xu VËt PhÈm"}}},
		[2] = {item={{gdp={2,1,504,9}, name="N÷ Oa Tinh Th¹ch"}, {gdp={2,95,204,19}, name="Thiªn Cang LÖnh"}, {gdp={2,1,30370,19}, name="Thiªn M«n Kim LÖnh"}, {gdp={2,1,30230,7900}, name="Xu VËt PhÈm"}}},
	}
	...
	local msg = format("Chóc mõng [%s] ®· n©ng cÊp th¸nh c«ng trang bÞ Th­¬ng ¦ng So¸i ChiÕn, ®ñ søc c©n c¶ chiÕn tr­êng !", GetName());
	Msg2Global(msg);
	AddLocalNews(msg);
