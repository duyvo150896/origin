...
function main()
		...
		if random(1,50) == 1 then
				NpcChat(GetTargetNpc(),"§Ó khÝch lÖ t­íng sÜ §¹i Liªu ta anh dòng giÕt giÆc, nh÷ng ai tham gia trËn ®¸nh Nh¹n m«n quan ®Òu ®­îc nhËn Linh Th¹ch!");
		end;
		battle_main();			
end;
...
function Denbu_NhanThuong4x_01(nChoice)
	...
	if nChoice == 1 then
		...
		--NhËn kinh nghiÖm
		gf_EventGiveCustomAward(1, floor(10000000/sep), 1, "DenBuHoaPhung", "Nhan")
	elseif nChoice == 2 then
		...
		if DelItem(2,1,9999,1) == 1 then
			...
			--NhËn kinh nghiÖm
			gf_EventGiveCustomAward(1, floor(15000000/sep), 1, "DenBuHoaPhung", "Nhan")
		end
	elseif nChoice == 3 then
		...
		if DelItem(2,1,9998,1) == 1 then
			...
			--NhËn kinh nghiÖm
			gf_EventGiveCustomAward(1, floor(20000000/sep), 1, "DenBuHoaPhung", "Nhan")
		end
	elseif nChoice == 4 then
		...
		if DelItem(2,1,9977,1) == 1 then
			...
			--NhËn kinh nghiÖm
			gf_EventGiveCustomAward(1, floor(30000000/sep), 1, "DenBuHoaPhung", "Nhan")
		end
	elseif nChoice == 5 then
		...
		if DelItem(2,1,30642,1) == 1 then
			...
			--NhËn kinh nghiÖm
			gf_EventGiveCustomAward(1, floor(45000000/sep), 1, "DenBuHoaPhung", "Nhan")
		end
	end
end
...
function Denbu_NhanThuong6x_01(nChoice)
	...
	elseif nChoice == 3 then
		...
		if DelItem(2,1,9998,1) == 1 then
			...
			--NhËn kinh nghiÖm
			gf_EventGiveCustomAward(1, floor(40000000/sep), 1, "DenBuHoaPhung", "Nhan")
		end
	elseif nChoice == 4 then
		if GetItemCount(2,1,9977) < 1 then 
			Talk(1,"",szNpcName.."C¸c h¹ kh«ng cã Qu©n C«ng Huy Hoµng trong hµnh trang. Kh«ng thÓ nhËn phÇn th­ëng!")
		...
		if DelItem(2,1,9977,1) == 1 then
			...
			--NhËn kinh nghiÖm
			gf_EventGiveCustomAward(1, floor(60000000/sep), 1, "DenBuHoaPhung", "Nhan")
		end
	elseif nChoice == 5 then
		if GetItemCount(2,1,30642) < 1 then 
			Talk(1,"",szNpcName.."C¸c h¹ kh«ng cã Qu©n C«ng Ch­¬ng Vinh Dù trong hµnh trang. Kh«ng thÓ nhËn phÇn th­ëng!")
		...
		if DelItem(2,1,30642,1) == 1 then
			...
			--NhËn kinh nghiÖm
			gf_EventGiveCustomAward(1, floor(90000000/sep), 1, "DenBuHoaPhung", "Nhan")
		end
	end
end
