...
Include("\\script\\vng\\tichluydoithuong\\tichluydoithuong.lua")
-- ======================================================
GOLD_COIN_2_TIME =
{
	-- ÌìÊý,	»¨·Ñ
...
function main()
	...
	local szHeader = "<color=green>"..szName.." :<color>L·o cã thÓ gióp g× cho quý kh¸ch ®©y ? Tõ 12-01 ®Õn 31-01"
	local tbSayDialog = {};
	local nSaySize = 0;
	if nDate >= 17021000 and nDate < 17030100 then
		tinsert(tbSayDialog, "Ta muèn tham gia ho¹t ®éng tÝch lòy ®iÓm/DoiThuongTichLuy")
	end
