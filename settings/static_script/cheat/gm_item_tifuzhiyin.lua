...
function thienghia_mod2()
	...
	if nBody==4 then
		...
		AddItem(0,101, 3055,1,1,5,639,3,483,2,613,-1,level);
		AddItem(0,103, 3055,1,1,-1,-1,-1,-1,-1,-1,-1,level);
		
		AddItem(0,100,3052,1,1,-1,-1,-1,-1,-1,-1,-1,level);
		AddItem(0,101, 3052,1,1,-1,-1,3,483,2,613,-1,level);
		AddItem(0,103, 3052,1,1,-1,-1,4,408,-1,-1,-1,level);
