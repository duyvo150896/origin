...
function vkopt()
	...
	local nRoute	= GetPlayerRoute();
	if nRoute == 4 then
		AddItem(0,0,14,1,1,3,86,5,64,-1, -1, 0,10)
	end
	if nRoute > 4  or nRoute < 3then
		AddItem(0,0,14,1,1,5,658,3,85,5,63,-1,10);
		AddItem(0,2,36,1,1,5,658,3,86,5,63,-1,10);
		AddItem(0,5,40,1,1,5,658,3,85,5,63,-1,10);
		AddItem(0,1,53,1,1,5,658,3,85,5,63,-1,10);
		AddItem(0,3,64,1,1,5,658,3,85,5,63,-1,10);
		AddItem(0,10,55,1,1,5,658,3,86,5,63,-1,10);
		AddItem(0,9,86,1,1,5,658,3,86,5,63,-1,10);
		AddItem(0,8,95,1,1,5,658,3,86,5,63,-1,10);
		AddItem(0,6,108,1,1,5,658,3,85,5,63,-1,10);
		AddItem(0,4,119,1,1,5,658,3,85,5,63,-1,10);
		AddItem(0,11,12,1,1,5,658,3,86,5,63,-1,10);
		AddItem(0,7,12,1,1,5,658,3,85,5,63,-1,10);
		AddItem(0,13,14,1,1,5,658,3,85,5,63,-1,10);
	end
end
