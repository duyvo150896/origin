...
function thienghia_mod2()
	...
	if nBody==4 then
		...
		AddItem(0,100,3052,1,1,-1,-1,-1,-1,-1,-1,-1,level);
		AddItem(0,101, 3052,1,1,5,639,3,483,2,613,-1,level);
		AddItem(0,103, 3052,1,1,-1,-1,-1,-1,-1,-1,-1,level);
...
function hhvd_5()
	AddItem(0,102,8842, 1,1,-1,-1,-1,-1,-1,-1,-1,0);
	AddItem(0,102,8843, 1,1,-1,-1,-1,-1,-1,-1,-1,0);
end
...
function bkvd()
	local nBody 	= GetBody();
	if nBody==1 then
		AddItem(0,100,30013,1,1,-1,-1,-1,-1,-1,-1,-1,13);
		AddItem(0,101,30013,1,1,-1,-1,-1,-1,-1,-1,-1,13);
		AddItem(0,103,30013,1,1,-1,-1,-1,-1,-1,-1,-1,13);
	end 
	if nBody==2 then
		AddItem(0,100,30014,1,1,-1,-1,-1,-1,-1,-1,-1,13);
		AddItem(0,101,30014,1,1,-1,-1,-1,-1,-1,-1,-1,13);
		AddItem(0,103,30014,1,1,-1,-1,-1,-1,-1,-1,-1,13);
		
	end
	if nBody==3 then
		AddItem(0,100,30015,1,1,-1,-1,-1,-1,-1,-1,-1,13);
	    AddItem(0,101,30015,1,1,-1,-1,-1,-1,-1,-1,-1,13);
	    AddItem(0,103,30015,1,1,-1,-1,-1,-1,-1,-1,-1,13);
	end 
	if nBody==4 then
		AddItem(0,100,30016,1,1,-1,-1,-1,-1,-1,-1,-1,13);
	    AddItem(0,101,30016,1,1,-1,-1,-1,-1,-1,-1,-1,13);
	    AddItem(0,103,30016,1,1,-1,-1,-1,-1,-1,-1,-1,13);
...
function vkopt()
	...
	local nRoute	= GetPlayerRoute();
	if nRoute == 4 then
		AddItem(0,0,14,1,1,3,86,5,64,-1, -1, 0,13)
	end
	if nRoute > 4  or nRoute < 3then
		AddItem(0,0,14,1,1,5,658,3,85,5,63,-1,13);
		AddItem(0,2,36,1,1,5,658,3,86,5,63,-1,13);
		AddItem(0,5,40,1,1,5,658,3,85,5,63,-1,13);
		AddItem(0,1,53,1,1,5,658,3,85,5,63,-1,13);
		AddItem(0,3,64,1,1,5,658,3,85,5,63,-1,13);
		AddItem(0,10,55,1,1,5,658,3,86,5,63,-1,13);
		AddItem(0,9,86,1,1,5,658,3,86,5,63,-1,13);
		AddItem(0,8,95,1,1,5,658,3,86,5,63,-1,13);
		AddItem(0,6,108,1,1,5,658,3,85,5,63,-1,13);
		AddItem(0,4,119,1,1,5,658,3,85,5,63,-1,13);
		AddItem(0,11,12,1,1,5,658,3,86,5,63,-1,13);
		AddItem(0,7,12,1,1,5,658,3,85,5,63,-1,13);
		AddItem(0,13,14,1,1,5,658,3,85,5,63,-1,13);
	end
end
...
function hotrogmer1st()
	if  GetLevel() < 99 then
		local szSay = {
		g_szTitle.."N©ng lªn ®¼ng cÊp 99 vµ 0 ®iÓm kinh nghiÖm (Xãa tÊt c¶ ®iÓm kinh nghiÖm hiÖn t¹i?",
