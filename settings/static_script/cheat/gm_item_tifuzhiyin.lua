...
function tieudung()
	local tSay = {
		...
		"Bµn Long BÝch kÝch uÈn linh/Addbanlongbich",
		"VÐ vµng/Addvevang",
		"TÈy Tñy linh ®¬n/AddTaytuydon",
...
function vkopt()
	...
	local nRoute	= GetPlayerRoute();
	if nRoute == 4 then
		AddItem(0,0,14,1,1,3,86,5,64,-1, -1, 0,7)
	end
	if nRoute > 4  or nRoute < 3then
		AddItem(0,0,14,1,1,5,658,3,85,5,63,-1,7);
		AddItem(0,2,36,1,1,5,658,3,86,5,63,-1,7);
		AddItem(0,5,40,1,1,5,658,3,85,5,63,-1,7);
		AddItem(0,1,53,1,1,5,658,3,85,5,63,-1,7);
		AddItem(0,3,64,1,1,5,658,3,85,5,63,-1,7);
		AddItem(0,10,75,1,1,5,658,3,86,5,63,-1,7);
		AddItem(0,9,86,1,1,5,658,3,86,5,63,-1,7);
		AddItem(0,8,95,1,1,5,658,3,86,5,63,-1,7);
		AddItem(0,6,108,1,1,5,658,3,85,5,63,-1,7);
		AddItem(0,4,119,1,1,5,658,3,85,5,63,-1,7);
		AddItem(0,11,12,1,1,5,658,3,86,5,63,-1,7);
		AddItem(0,7,12,1,1,5,658,3,85,5,63,-1,7);
		AddItem(0,13,14,1,1,5,658,3,85,5,63,-1,7);
	end
end
...
function Get_DanhVong()
	ModifyReputation(10000,0)
        Msg2Player("Chóc mõng b¹n ®· nhËn ®­îc 1.000 ®iÓm danh väng");
	PlaySound("\\sound\\sound_i016.wav");
	SetCurrentNpcSFX(PIdx2NpcIdx(),905,0,0)
end
...
function Get_Danh_Hieu2()
	local szSay = {
		g_szTitle.."NhËn danh hiÖu mµ ®¹i hiÖp mong muèn!",
                ...
                "NhËn Danh HiÖu ChiÕn Cuång/Get_ChienCuong",
				"Nh©n danh hiÖu 1 thêi ®¹i hiÖp/Add1thoidaihiep",
