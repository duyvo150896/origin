					...
					t_item =
						{
							...
							{2, 1, 30730, 20, "Kinh M筩h уng Nh﹏"},
							{2, 1, 30351, 10, "B錳 Nguy猲 Кn"},
							{2, 1, 30458, 10, "T?Linh Ho祅"},
						},
				},
			global_msg = 1,
		},
			...
			t_ib_consume =
				{
					...
					t_item =
						{
							{2, 95,  204, 2, "Thi猲 Cang L謓h"	},
							{2, 1, 30370, 2, "Thi猲 M玭 Kim L謓h"	},
						},
				},
			global_msg = 1,
		},
			...
			t_ib_consume =
				{
					...
					t_item =
						{
							{2, 95,  204, 4, "Thi猲 Cang L謓h"	},
							{2, 1, 30370, 4, "Thi猲 M玭 Kim L謓h"	},
						},
				},
			global_msg = 1,
		},
...
function meridianlevel_check_require(nNewLevel, bNotify)
	...
	if MeridianGetLevel() >= nNewLevel then
		Talk(1,"",format("Ngi  k輈h ho箃 %s c秐h gi韎!", tCfg.sz_name))
		return 0
	end
